...
export declare const fieldResolver: <TSource, TContext, TArgs = any, TResult = unknown>(handler: IDataProtectorHandler, resolve: GraphQLFieldResolver<TSource, TContext, TArgs, TResult>, directiveType: Maybe<ProtectionType>, directiveFields?: string[]) => GraphQLFieldResolver<TSource, TContext, TArgs, Promise<TResult>>;
...
}, TResult>, directiveType: Maybe<ProtectionType>) => GraphQLFieldResolver<TSource, TContext, {
    directiveFields: string[];
}, Promise<TResult>>;
